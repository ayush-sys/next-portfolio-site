...
export default function Education() {
  return (
    ...
    <div className="py-12 bg-white" id="education">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center font-head">
          <p className="mt-2 text-3xl leading-8 font-extrabold tracking-wide text-gray-900 sm:text-4xl">
            Education
          </p>
        </div>

        <div className="mt-10 flex flex-row md:justify-center md:items-center font-body">
            <dl>
