      ...
      <div className="flex items-center justify-center w-full px-6 py-8 lg:h-[32rem] lg:w-1/2">
        <div className="max-w-xl">
          ...
          <p className="mt-4 text-sm text-gray-600 lg:text-base tracking-wide">
            ...
            Blanditiis commodi cum cupiditate ducimus, fugit harum id necessitatibus odio quam quasi, quibusdam rem tempora voluptates.</p>

          <div className="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row lg:space-x-4">
            <a href="#" className="about-link-btn text-white bg-gray-900 hover:bg-gray-800">
